...
[Installing](#ht-server)<br/>
[Contributing](#ht-contribute)<br/>
...
4. _type:_ flying, archers, cavalry, infantry.
...
There is a plethora of ways to set the bot up. Some more technical than others. For instance:
...
Hopefully, quick-quick does his work well. If he's acting up please make a formal complaint [here](https://github.com/Gnome-Lackey/quick-quick-bot/issues) specifying the commands issued, the responses (or lack thereof) received, and the desired outcome you expected.
...
1) Fork the repo please! We want to keep the core repo clean, and managed by the Gnome Lackey team. That doesn't mean we don't want your code! On the contrary. We just want your branches, and work kept separate from ours until its ready (and approved) to be merged into ours.
